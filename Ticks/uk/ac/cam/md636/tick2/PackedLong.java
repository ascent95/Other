...
public class PackedLong {
    /*
     * Unpack and return the nth bit from the packed number at index position; position counts from
     * zero (representing the least significant bit) up to 63 (representing the most significant
     * bit).
     */
